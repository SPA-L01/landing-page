    ...
    <div className="min-h-screen bg-background text-on-surface font-body selection:bg-primary/30">
      ...
      <header className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-xl border-b border-outline-variant/10 flex justify-between items-center px-6 h-16">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-bold text-primary tracking-tighter font-headline">Antigravity</span>
        </div>
      ...
      <main className="pt-16 overflow-x-hidden">
        {/* Hero Section */}
        <section className="relative px-6 pt-20 pb-16 flex flex-col items-start bg-surface-container-low rounded-b-[2rem] overflow-hidden">
          ...
          >
            The future of urban parking: Antigravity
          </motion.h1>
          ...
          >
            Solving urban congestion with AI-driven space detection. Integrate our open-source parking algorithms into your smart city infrastructure.
          </motion.p>
        ...
        <section className="py-32 px-6 bg-surface text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-on-surface-variant text-lg md:text-xl mb-12">Integrate our SDK or contribute to the core algorithms. Join the Antigravity developer community.</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-20">
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-2xl font-black text-primary font-headline">Antigravity</span>
              </div>
              <p className="text-on-surface-variant max-w-xs">
                Revolutionizing urban mobility through open-source collaboration and AI.
              </p>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-on-surface-variant text-sm opacity-60">
              © 2024 Antigravity Mobility Foundation. Built for smart cities.
            </p>
